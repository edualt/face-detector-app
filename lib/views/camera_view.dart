...
import 'package:my_face_recognition_app/controllers/scan_controller.dart';
                        ...
                        ? Column(
                          children: [
                            ...
                            SizedBox(
                                ...
                                child: Center(
                                  child: Text(
                                    "La temperatura es ${ controller.weatherRequested ? controller.weather : CircularProgressIndicator()} °C",
                                    textAlign: TextAlign.center,
                                    style: const TextStyle(
                                      fontSize: 16,
                                      fontWeight: FontWeight.bold,
